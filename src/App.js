...
class App extends Component {
  render() {
    ...
    <!--END SLIDER--> */}
            ...
            $("#dvYoutube").html("<iframe style={{ width: '100%', height: '400px' }} src={require('https://www.youtube.com/embed/IyucJZev9wM')} frameborder='0' webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>");
              });
    </script>

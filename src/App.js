    ...
    <!--END SLIDER--> */}
                ...
                <section className="home-cat-sec text-center">
                  <div className="container-fluid">
                    <h2 className="site-title">Sellers, use <a href="http://iticket.kyazoonga.com/" target="_blank"><img src="http://www.kyazoonga.com/images/iticket-logo.png"
                    ...
                    <div className="row footer-links">
                      ...
                      <div className="col-sm-3 country-flag-sec">
                        ...
                        <ul>
                          ...
                          <li><a href="http://www.kyazoonga.ae/" target="_blank"><img src="./images/CountriesFlag/uae.png" />United
                                Arab Emirates</a></li>
